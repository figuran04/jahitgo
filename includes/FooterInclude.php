<footer class="border-t border-[rgba(0,0,0,0.2)] bg-gray-50">
    <p class="p-20 bg-green-600">footer</p>
</footer>

<!-- Modal logout -->
<div id="logoutModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 transition-opacity duration-200">
